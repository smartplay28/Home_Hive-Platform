...
const AgentSignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save JWT tokens + user info (also sets agentId in localStorage for legacy compat)
      saveAuth(loginData);
  ...
  return (
    <div className="min-h-screen bg-[#eaf0f7] p-8">
      ...
      <div className="flex flex-col items-center mb-12">
        ...
        <p className="text-sm text-gray-500 mt-1">Service Agent Portal</p>
      </div>

      {/* Sign In Form */}
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-2xl font-semibold text-[#1c4e80] mb-8">Agent Sign In</h2>
